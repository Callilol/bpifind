...
{:name => 'Grolier_LandsPeople', :full_name => 'Lands and People', :connection_type => 'test', :host => '10.1.2.100', :user => 'postgresbpi', :password => 'postgresbpi', :record_schema => 'test', :definition => 'test', :word => 'test', :url => 'test'},
